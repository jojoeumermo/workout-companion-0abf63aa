...
import { Play, Dumbbell, TrendingUp, Flame, Zap, Target, ChevronRight, BookOpen, Settings, UtensilsCrossed, Utensils, Scale, Droplets, Clock, Trophy, AlertTriangle, Star } from 'lucide-react';
        ...
        <motion.div custom={2} variants={stagger} initial="hidden" animate="show" className="space-y-3">
          ...
          <div className="grid grid-cols-3 gap-2.5">
            {[
              ...
              { icon: Utensils, label: 'Refeição', action: () => navigate('/nutricao') },
